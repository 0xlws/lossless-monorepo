...
import '../v4-core/interfaces/ITicket.sol';
import '../v4-core/interfaces/IPrizeDistributionBuffer.sol';
import '../v4-core/interfaces/IPrizeDistributionSource.sol';
import '../v4-core/libraries/ExtendedSafeCastLib.sol';
...
contract PrizeDistributionFactoryV2 is Manageable {
    ...
    returns (IPrizeDistributionBuffer.PrizeDistribution memory)
  {
    ...
    (uint64[] memory _startTimes, uint64[] memory _endTimes) = _calculateDrawPeriodTimestampOffsets(
      _draw.timestamp,
    ...
    IPrizeDistributionBuffer.PrizeDistribution memory _prizeDistribution = IPrizeDistributionSource
      .PrizeDistribution({
