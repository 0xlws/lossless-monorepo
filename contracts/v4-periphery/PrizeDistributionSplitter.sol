...
contract PrizeDistributionSplitter is IPrizeDistributionSource {
    ...
    returns (IPrizeDistributionSource.PrizeDistribution[] memory)
  {
    ...
    IPrizeDistributionSource.PrizeDistribution[]
      memory _prizeDistributionsAtOrAfter = prizeDistributionSourceAtOrAfter.getPrizeDistributions(
        _drawIdsAtOrAfter
      );

    IPrizeDistributionSource.PrizeDistribution[]
      memory _prizeDistributions = new IPrizeDistributionSource.PrizeDistribution[](_drawIdsLength);
