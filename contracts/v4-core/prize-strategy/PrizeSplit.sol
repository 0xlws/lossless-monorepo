...
import '../../owner-manager-contracts/Ownable.sol';
...
abstract contract PrizeSplit is IPrizeSplit, Ownable {
  ...
  /// @inheritdoc IPrizeSplit
  function setPrizeSplits(PrizeSplitConfig[] calldata _newPrizeSplits) external override onlyOwner {
    ...
    require(
      totalPercentage <= ONE_AS_FIXED_POINT_3,
      'PrizeSplit/invalid-prizesplit-percentage-total'
    );
  }
    ...
    onlyOwner
  {
    ...
    emit PrizeSplitSet(_prizeSplit.target, _prizeSplit.percentage, _prizeSplitIndex);
  }
